...
<script>
    // 我的随笔模块的自定义样式;
    import MyArticleStyle from '../components_style_attr/my-article-style-attr.js';
    import MyArticleItem from '../components/my-article-item.vue';
    export default {
        components:{
            MyArticleItem
        },
        data () {
            return {
                cardStyle:MyArticleStyle.cardStyle,
                movieList: [
                    {
